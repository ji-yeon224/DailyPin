...
final class GoogleNetwork {
    ...
    func requestGeocoder(api: Router, completion: @escaping (Result<GeocodingResDto, NetworkError>) -> Void) {
        
        AF.request(api).responseDecodable(of: GeocodingResDto.self) { response in
