...
extension Constants {
    ...
    enum Image {
        ...
        static let noPlaceList = UIImage(systemName: "highlighter")
        ...
        static let searchButtonBg = UIImage(named: "SearchBg")
        ...
        static let returnTodayButton = UIImage(named: "ReturnToday")
